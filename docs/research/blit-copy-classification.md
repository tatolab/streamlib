...
```rust
// runtime/streamlib-engine/src/core/rhi/blitter.rs
...
`runtime/streamlib-engine/src/metal/rhi/blitter.rs`.
...
`runtime/streamlib-engine/src/vulkan/rhi/vulkan_blitter.rs`.
...
- Defined on the trait (`runtime/streamlib-engine/src/core/rhi/blitter.rs:28`).
...
| File | Line | Call |
|---|---|---|
| `runtime/streamlib-engine/src/apple/processors/screen_capture.rs` | 171 (→ 242) | `gpu_context.blit_copy_iosurface` |
| `packages/camera/src/apple/camera.rs` | 236 (→ 325) | `gpu_context.blit_copy_iosurface` |
| `runtime/streamlib-engine/src/apple/videotoolbox/decoder.rs` | 413 | `gpu.blit_copy` |
...
- Metal blitter: `runtime/streamlib-engine/src/metal/rhi/blitter.rs`
- Vulkan blitter: `runtime/streamlib-engine/src/vulkan/rhi/vulkan_blitter.rs`
- Blitter trait: `runtime/streamlib-engine/src/core/rhi/blitter.rs`

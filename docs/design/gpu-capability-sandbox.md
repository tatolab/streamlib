...
`runtime/streamlib-engine/src/core/processors/traits/reactive.rs`). `setup()` is
...
Today (`runtime/streamlib-engine/src/core/compiler/compiler_ops/spawn_processor_op.rs:373–417`):
...
Today (`runtime/streamlib-engine/src/core/context/runtime_context.rs:12–34`):
...
Today (`runtime/streamlib-engine/src/core/processors/traits/reactive.rs:14–37`):
...
`runtime/streamlib-engine/src/core/compiler/compiler_ops/spawn_python_native_subprocess_op.rs`
...
Control-channel schema (in `runtime/streamlib-engine/schemas/`, YAML → JTD →

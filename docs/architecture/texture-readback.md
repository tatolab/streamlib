...
- Implementation: `runtime/streamlib-engine/src/vulkan/rhi/vulkan_texture_readback.rs`
- Public types: `runtime/streamlib-engine/src/core/rhi/texture_readback.rs`

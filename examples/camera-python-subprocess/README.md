...
Camera → a Python grayscale processor → Display. The Python subprocess reads
camera pixels through shared memory (no pixel data through pipes), converts to
grayscale with numpy, and forwards the result to the display.

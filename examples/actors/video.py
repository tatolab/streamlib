"""
Reference video actor implementations.

These are EXAMPLES showing how to build video actors using external libraries.
Not part of streamlib core - use as starting points for your own implementations.

Actors:
- TestPatternActor: Generate test patterns (SMPTE bars, gradients, etc.)
- DisplayActor: Display video in window with OpenCV
...
from streamlib import Actor, StreamOutput, StreamInput

"""
Reference compositor actor implementation.

This is an EXAMPLE showing how to build a compositor using NumPy.
Not part of streamlib core - use as a starting point for your own implementation.

Shows:
- Multi-input actor pattern
- Alpha blending with NumPy
- Performance considerations (uint16 arithmetic)

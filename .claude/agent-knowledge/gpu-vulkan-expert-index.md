...
| GPU code that hand-rolls an RHI object on a raw device double-frees in the NVIDIA driver (`vkCreatePipelineLayout` / `libnvidia-gpucomp`), and it ran clean for a long time first | `docs/learnings/slpkg-raw-device-rhi-construction.md` |

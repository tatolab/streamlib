"""
Drawing actors for programmatic graphics generation.

This module provides actors that generate graphics using Skia:
- DrawingActor: Execute Python drawing code to generate video
"""
...
from ..actor import Actor, StreamOutput

...
# Generate .envrc file for direnv
generate_envrc() {
    local envrc_file="${REPO_ROOT}/.envrc"

    info "Generating .envrc for direnv..."

    # Start with PyO3 config from example if it exists, otherwise use defaults
    cat > "$envrc_file" << 'EOF'
# StreamLib Development Environment (auto-generated by dev-setup.sh)
# Re-run ./scripts/dev-setup.sh to regenerate
...
export PYTHONHOME="/opt/homebrew/opt/python@3.12/Frameworks/Python.framework/Versions/3.12"

EOF

    # Append StreamLib-specific env vars
    cat >> "$envrc_file" << EOF
# =============================================================================
# StreamLib Dev Environment
# =============================================================================
...
EOF
    ...
    success "Generated .envrc"
    info "Run 'direnv allow' to load the environment"
}

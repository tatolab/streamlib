...
# SPDX-License-Identifier: BUSL-1.1
#
# AUTOGENERATED BY `streamlib add`. DO NOT EDIT BY HAND.
#
# This lockfile records every package materialized into this app's
# streamlib_modules/ folder — identity, source, and content hash — so the
# folder's provenance is auditable and reproducible. Commit it alongside
# the app.
";

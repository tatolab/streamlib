...
class APIServerConfig:
    ...
    def from_json_data(cls, data: Any) -> 'APIServerConfig':
        return cls(
            ...
            _from_json_data(Optional[str], data.get("log_path")),
            _from_json_data(Optional[str], data.get("name")),
        )

    def to_json_data(self) -> Any:
        data: Dict[str, Any] = {}
        data["host"] = _to_json_data(self.host)
        data["port"] = _to_json_data(self.port)
        if self.log_path is not None:
             data["log_path"] = _to_json_data(self.log_path)

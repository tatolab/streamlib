...
class AudioMixerConfigStrategy(Enum):
    """
    Mixing strategy for combining signals
    """

    SUM = "Sum"
    SUM_CLIPPED = "SumClipped"
    SUM_NORMALIZED = "SumNormalized"
    @classmethod
    def from_json_data(cls, data: Any) -> 'AudioMixerConfigStrategy':
        return cls(data)
...
class AudioMixerConfig:
    ...
    @classmethod
    def from_json_data(cls, data: Any) -> 'AudioMixerConfig':
        return cls(
            _from_json_data(AudioMixerConfigStrategy, data.get("strategy")),
        )

    def to_json_data(self) -> Any:
        data: Dict[str, Any] = {}
        data["strategy"] = _to_json_data(self.strategy)
        return data

...
class BufferRechunkerConfig:
    ...
    @classmethod
    def from_json_data(cls, data: Any) -> 'BufferRechunkerConfig':
        return cls(
            _from_json_data(int, data.get("target_buffer_size")),
        )

    def to_json_data(self) -> Any:
        data: Dict[str, Any] = {}
        data["target_buffer_size"] = _to_json_data(self.target_buffer_size)
        return data

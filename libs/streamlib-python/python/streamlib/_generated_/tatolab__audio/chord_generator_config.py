...
class ChordGeneratorConfig:
    ...
    @classmethod
    def from_json_data(cls, data: Any) -> 'ChordGeneratorConfig':
        return cls(
            _from_json_data(float, data.get("amplitude")),
    ...
    def to_json_data(self) -> Any:
        data: Dict[str, Any] = {}
        data["amplitude"] = _to_json_data(self.amplitude)

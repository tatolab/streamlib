...
class AudioChannelConverterConfigMode(Enum):
    """
    ...
    @classmethod
    def from_json_data(cls, data: Any) -> 'AudioChannelConverterConfigMode':
        return cls(data)
...
@dataclass
class AudioChannelConverterConfig:
    """
    ...
    __streamlib_schema_ident__: ClassVar[SchemaIdent] = SchemaIdent(
        org="tatolab",
        package="audio",
        type_="AudioChannelConverterConfig",
        version="1.0.0",
    )
    ...
    @classmethod
    def from_json_data(cls, data: Any) -> 'AudioChannelConverterConfig':
        return cls(
            _from_json_data(AudioChannelConverterConfigMode, data.get("mode")),
            _from_json_data(Optional[int], data.get("output_channels")),
        )
    ...
    def to_json_data(self) -> Any:
        ...
        if self.output_channels is not None:
             data["output_channels"] = _to_json_data(self.output_channels)
        return data

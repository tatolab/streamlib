...
class LinuxMp4WriterConfig:
    ...
    @classmethod
    def from_json_data(cls, data: Any) -> 'LinuxMp4WriterConfig':
        return cls(
            _from_json_data(int, data.get("fps")),
            _from_json_data(str, data.get("output_path")),
            _from_json_data(Optional[int], data.get("duration_secs")),
        )
    ...
    def to_json_data(self) -> Any:
        ...
        if self.duration_secs is not None:
             data["duration_secs"] = _to_json_data(self.duration_secs)
        return data

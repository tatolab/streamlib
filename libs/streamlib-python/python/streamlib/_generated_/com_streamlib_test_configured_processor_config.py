...
@dataclass
class ConfiguredProcessorConfig:
    """
    ...
    @classmethod
    def from_json_data(cls, data: Any) -> 'ConfiguredProcessorConfig':
        return cls(
            _from_json_data(float, data.get("threshold")),
        )

    def to_json_data(self) -> Any:
        data: Dict[str, Any] = {}
        data["threshold"] = _to_json_data(self.threshold)
        return data

...
class MoqPublishTrackConfig:
    ...
    @classmethod
    def from_json_data(cls, data: Any) -> 'MoqPublishTrackConfig':
        return cls(
            _from_json_data(Optional[str], data.get("track_name")),
        )

    def to_json_data(self) -> Any:
        data: Dict[str, Any] = {}
        if self.track_name is not None:
             data["track_name"] = _to_json_data(self.track_name)
        return data

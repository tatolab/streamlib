...
class CameraConfig:
    ...
    @classmethod
    def from_json_data(cls, data: Any) -> 'CameraConfig':
        return cls(
            _from_json_data(Optional[str], data.get("device_id")),
            _from_json_data(Optional[float], data.get("max_fps")),
            _from_json_data(Optional[float], data.get("min_fps")),
        )

    def to_json_data(self) -> Any:
        data: Dict[str, Any] = {}
        if self.device_id is not None:
             data["device_id"] = _to_json_data(self.device_id)
        if self.max_fps is not None:
             data["max_fps"] = _to_json_data(self.max_fps)
        if self.min_fps is not None:
             data["min_fps"] = _to_json_data(self.min_fps)
        return data

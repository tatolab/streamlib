...
class WebrtcWhepConfigWhep:
    ...
    @classmethod
    def from_json_data(cls, data: Any) -> 'WebrtcWhepConfigWhep':
        return cls(
...
class WebrtcWhepConfig:
    ...
    @classmethod
    def from_json_data(cls, data: Any) -> 'WebrtcWhepConfig':
        return cls(
            _from_json_data(WebrtcWhepConfigWhep, data.get("whep")),
        )

    def to_json_data(self) -> Any:
        data: Dict[str, Any] = {}
        data["whep"] = _to_json_data(self.whep)
        return data

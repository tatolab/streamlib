...
use limited::{
    ...
    host_gpu_lim_acquire_texture, host_gpu_lim_acquire_uniform_buffer,
    host_gpu_lim_acquire_vertex_buffer, host_gpu_lim_clear_video_source_timeline_semaphore,
    host_gpu_lim_clone_index_buffer, host_gpu_lim_clone_storage_buffer, host_gpu_lim_clone_texture,
    host_gpu_lim_clone_texture_registration, host_gpu_lim_clone_uniform_buffer,
    host_gpu_lim_clone_vertex_buffer, host_gpu_lim_drop_index_buffer,
    host_gpu_lim_drop_pooled_texture_handle, host_gpu_lim_drop_storage_buffer,
    ...
    host_gpu_lim_escalate_end, host_gpu_lim_host_video_source_timeline_arc,
    ...
    host_gpu_lim_set_video_source_timeline_semaphore, host_gpu_lim_texture_native_dma_buf_fd,

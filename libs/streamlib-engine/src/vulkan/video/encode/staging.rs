...
impl SimpleEncoder {
    ...
    pub(crate) unsafe fn create_internal(config: SimpleEncoderConfig) -> Result<SimpleEncoder, VideoError> { unsafe {
        ...
        let app_info = vk::ApplicationInfo::builder()
            ...
            .api_version(crate::vulkan::video::video_context::REQUIRED_VULKAN_API_VERSION);
        ...
        crate::vulkan::video::video_context::reject_software_renderer(&instance, physical_device)?;

...
use crate::vulkan::video::vk_video_encoder::vk_video_encoder_def::{div_up, gcd};
...
impl Default for EncoderConfigH264 {
    fn default() -> Self {
        ...
        Self {
            ...
            sps_id: 0,
            pps_id: 0,
            num_slices_per_picture: crate::vulkan::video::vk_video_encoder::vk_encoder_config::DEFAULT_NUM_SLICES_PER_PICTURE,
            slice_count: 1,
...
impl EncoderConfigH264 {
    ...
    ) -> crate::vulkan::video::vk_video_encoder::vk_video_encoder_state_h264::EncoderH264State {
        use crate::vulkan::video::vk_video_encoder::vk_video_encoder_state_h264::*;

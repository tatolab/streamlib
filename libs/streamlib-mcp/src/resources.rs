...
pub fn read_resource(
    ...
    let json = registration.descriptor.to_json()
...
mod tests {
    use super::*;
    use streamlib_core::{ProcessorDescriptor, ProcessorRegistry};
    ...
    fn register_test_processor(registry: &Arc<Mutex<ProcessorRegistry>>) {
        ...
        let factory = StdArc::new(|| {
            Err(streamlib_core::StreamError::Configuration("Test".into()))
        });

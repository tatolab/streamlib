...
mod tests {
    ...
    fn test_audio_requirements_serialization() {
        ...
        assert!(parsed.get("audio_requirements").is_some(),
        ...
        assert!(audio_req.get("required_buffer_size").is_none(),
    ...
    fn test_audio_requirements_compatibility() {
        ...
        assert!(flexible.compatible_with(&strict),
        ...
        assert!(!strict.compatible_with(&different),
        ...
        assert!(error_msg.to_lowercase().contains("buffer size") || error_msg.contains("Buffer"),

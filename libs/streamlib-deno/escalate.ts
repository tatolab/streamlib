 ...
 *
 * Wire types (`EscalateRequest`, `EscalateResponse`, …) are owned by
 * `@tatolab/escalate` (`packages/escalate/schemas/escalate_{request,response}.yaml`)
 * and generated into `_generated_/tatolab__escalate/` via
 * `cargo xtask generate-schemas --runtime typescript`. This file owns
 * only the channel coordination logic (request-id bookkeeping,

...
/// - v4: dropped both v3 slots. Live registration from source text went
///   with the module system that staged it; code is the source of truth.
pub const RUNTIME_OPS_VTABLE_LAYOUT_VERSION: u32 = 4;
...
mod tests {
    ...
    fn runtime_ops_vtable_layout() {
        // 4 + 4 + 7 fn pointers (5 submit ops + clone_handle + drop_handle) = 64 bytes

...
pub struct VideoFrame {
    ...
    pub height: u32,
    /// Monotonic timestamp in nanoseconds, stamped via `MediaClock` — this
    /// machine's monotonic epoch, comparable to V4L2 / ALSA driver stamps and
    /// to any reading taken on the same machine. A stamp from another machine
    /// is a reading of an unrelated clock.

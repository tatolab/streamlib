...
//!
//! This file is a logic-identical twin of the engine-free SDK's
//! `sdk/streamlib-plugin-sdk/src/plugin/layout_skew_diagnostic.rs` — the
//! two are held in sync by `twin_drift_guard`. Apply every change to BOTH.

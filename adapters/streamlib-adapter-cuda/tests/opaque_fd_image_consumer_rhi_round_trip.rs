...
fn opaque_fd_image_carve_out_round_trip() {
    ...
    unsafe {
        common::submit_one_shot(host_dev, host_queue, host_qfi, |cmd| {
            common::record_pattern_upload_to_image(
                host_dev,
                cmd,
                source_buf.buffer(),
                host_vk_image,
    ...
    // spec status lives on `common::record_image_readback_to_buffer`).
    ...
    unsafe {
        common::submit_one_shot(consumer_dev, consumer_queue, consumer_qfi, |cmd| {

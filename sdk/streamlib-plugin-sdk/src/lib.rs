...
pub mod sdk {
    ...
    pub mod rhi {
        pub use crate::rhi::{
            ...
            ImageCopyRegion, IndexType, MultisampleState, NativeTextureHandle, OffscreenColorTarget,
            OffscreenDraw, PixelFormat, PolygonMode, PresentTarget, PresentTargetFrame,
            PrimitiveTopology, RasterizationState, ReadbackTicket, RhiColorConverter,
            RhiCommandRecorder, ScissorRect, SourceLayoutInfo, StorageBuffer, SurfaceStore,
            TEXTURE_RING_SLOT_SURFACE_ID_MAX_BYTES, Texture, TextureDescriptor, TextureFormat,
            TextureReadback, TextureRing, TextureRingSlot, TextureSourceLayout, TextureUsages,

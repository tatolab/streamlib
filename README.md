...
StreamLib also distributes third-party code. Every dependency's copyright notice and licence
text is reproduced in [THIRD-PARTY-NOTICES.md](THIRD-PARTY-NOTICES.md), which the wheel ships
in its `.dist-info/licenses/`.

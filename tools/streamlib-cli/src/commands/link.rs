...
const PYTHON_SDK_REL: &str = "sdk/streamlib-python";
/// Checkout-relative path of the Deno SDK entrypoint module.
const DENO_SDK_ENTRYPOINT_REL: &str = "sdk/streamlib-deno/mod.ts";
...
fn plan_pyproject_edit(
    ...
    // [tool.uv.sources] streamlib = { path = "<checkout>/sdk/streamlib-python", editable = true }
